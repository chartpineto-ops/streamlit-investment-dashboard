...
FEED_CONTRACTS: tuple[FeedContract, ...] = (
    ...
    FeedContract(
        "Economic",
        "Supplementary macro series",
        "FRED",
        "Unavailable - synthetic values prohibited",
        300,
        ("FRED_API_KEY",),
        "Preserve observation period, release time, and revisions as separate fields.",
        configured_status="Official",
        fallback_status="Unavailable",
    ),
    FeedContract(
        "Economic",
        "CPI and labor releases",
        "BLS Public Data API",
        "Unavailable - synthetic values prohibited",
        60,
        (),
        "Match series ID, seasonal adjustment, observation period, and official release calendar.",
        configured_status="Official",
        fallback_status="Unavailable",
    ),
    FeedContract(
        "Economic",
        "Release calendars",
        "BLS ICS / BEA schedule",
        "Last verified schedule",
        21_600,
        (),
        "Treat scheduled time as upcoming until the official observation actually changes.",
        configured_status="Official schedule",
        fallback_status="Stale schedule",
    ),
    FeedContract(
        "Social",
